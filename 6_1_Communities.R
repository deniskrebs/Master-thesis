...
pdf("./R_Output/cache/communities_louvain_graph_g.simp.un.pdf", width=100, height=100)
...
pdf("./R_Output/cache/communities_walktrap_graph_g.simp.un.pdf", width=100, height=100)
...
pdf("./R_Output/cache/communities_labelpropagation_graph_g.simp.un.pdf", width=100, height=100)
